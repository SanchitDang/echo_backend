...
urlpatterns = [
    ...
    # Panel Users
    path('list-panel-users', views.list_panel_users, name='list_panel_users'),
    path('panel-users', views.panel_users, name='panel_users'),
    path('panel-users-admin', views.panel_users_admin, name='panel_users_admin'),
    path('panel-users-execution', views.panel_users_execution, name='panel_users_execution'),
    path('panel-users-service_support', views.panel_users_service_support, name='panel_users_service_support'),
    path('panel-users-freelancers', views.panel_users_freelancers, name='panel_users_freelancers'),
    path('panel-users-referral', views.panel_users_referral, name='panel_users_referral'),

    path('add-panel-user/', views.add_panel_user, name='add_panel_user'),
